...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final LinphoneLibraryAccessors laccForLinphoneLibraryAccessors = new LinphoneLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>linphone</b>
     */
    public LinphoneLibraryAccessors getLinphone() {
        return laccForLinphoneLibraryAccessors;
    }
    ...
    public static class LinphoneLibraryAccessors extends SubDependencyFactory {
        private final LinphoneSdkLibraryAccessors laccForLinphoneSdkLibraryAccessors = new LinphoneSdkLibraryAccessors(owner);

        public LinphoneLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>linphone.sdk</b>
         */
        public LinphoneSdkLibraryAccessors getSdk() {
            return laccForLinphoneSdkLibraryAccessors;
        }

    }

    public static class LinphoneSdkLibraryAccessors extends SubDependencyFactory {

        public LinphoneSdkLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>android</b> with <b>org.linphone:linphone-sdk-android</b> coordinates and
         * with version reference <b>linphone</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getAndroid() {
            return create("linphone.sdk.android");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>linphone</b> with value <b>5.3.77</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getLinphone() { return getVersion("linphone"); }
